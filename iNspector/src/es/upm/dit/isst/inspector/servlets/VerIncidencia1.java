 ...
 */
@WebServlet("/VerIncidencia1")
public class VerIncidencia1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VerIncidencia1() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int localID1 = Integer.parseInt(local);
		System.out.println(local);
		System.out.println(localID1);
		
		Local local1 = new Local();
		
			 local1 = LocalDAOImplementation.getInstance().read2(localID1);
		
		String loc= local1.getRotulo();
		...
		req.getSession().setAttribute("Local", loc);
