 ...
 */
@WebServlet("/FormEliminaFavorito")
public class FormEliminaFavorito extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FormEliminaFavorito() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Favorito fav1= FavoritoDAOImplementation.getInstance().read(email, rotulo);
		System.out.println(fav1);

		
		FavoritoDAOImplementation.getInstance().delete(email, rotulo);
