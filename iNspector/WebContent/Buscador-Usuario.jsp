...
<link rel="stylesheet" href="Buscador-Usuario.css" media="screen">
    ...
    <meta property="og:title" content="Buscador No registrado">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-4-base u-sticky u-header" id="sec-2a1f"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="sec-227a" data-image-width="150" data-image-height="99">
      <div class="u-clearfix u-sheet u-sheet-1">
       ...
       <% if(reg=="no"){ %> 
        <h5 class="u-text u-text-default u-text-16">¿Quieres añadir una incidencia de este local o añadirlo a favoritos?</h5>
        <h5 class="u-align-center u-text u-text-17">
          <a href="Registrarse.jsp">Haz click aquí&nbsp;para registrarte</a>
        </h5>
        <h5 class="u-align-center u-text u-text-default u-text-18">¿Ya tienes una cuenta?</h5>
        <h5 class="u-align-center u-text u-text-19">
          <a href="Login.jsp">Haz click aquí para iniciar sesión</a>
        </h5>
         <% } %>
