...
<%@ taglib prefix = "fmt" uri = "http://java.sun.com/jsp/jstl/fmt" %>
  <header class="u-clearfix u-header u-palette-4-base u-sticky u-header" id="sec-2a1f"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="sec-8fb2" data-image-width="1280" data-image-height="853">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-heading-font u-text u-text-default u-title u-text-1" data-animation-name="fadeIn" data-animation-duration="1000" data-animation-delay="0">Resultados</h1>
        <div class="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
          ...
          <div class="u-align-center u-large-text u-text u-text-font u-text-variant u-text-2 ">
			...
			<c:forEach items = "${rotulos}" var = "rotulos">
            ...
            <div class="u-align-center u-form-group u-form-submit">
                  <button type="submit" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-button-style">ir</button>
