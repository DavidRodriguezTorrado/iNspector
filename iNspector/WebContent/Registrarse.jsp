...
<body class="u-body">
	<header class="u-clearfix u-header u-palette-4-base u-sticky u-header"
		id="sec-2a1f">
			...
			<div class="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
				<form action="BuscadorLocalesServlet">
					<div class="u-form-group u-form-name">
						...
						<input type="text" placeholder="Busca un restaurante..."
							id="rotulo" name="rotulo"
							class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-gradient u-input u-input-round u-input-1"
							required="">
					</div>
					<div class="u-form-group u-form-submit">
						<a href="#"
							class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-button-style u-palette-4-dark-2 u-btn-1">Buscar</a>
	...
	<section class="u-clearfix u-image u-shading u-section-1" src=""
		id="sec-cb27">
		<div class="u-clearfix u-sheet u-valign-top u-sheet-1">
			<div
				class="u-container-style u-group u-opacity u-opacity-70 u-white u-group-1">
				<div class="u-container-layout u-container-layout-1">
					<h3 class="u-align-center u-text u-text-palette-4-base u-text-1">Regístrate</h3>
					<p
						class="u-align-center u-text u-text-default u-text-grey-75 u-text-2">Navegar
						identificado te permite disfrutar de ventajas únicas para nuestros
						usuarios, como añadir tus restaurantes favoritos y reportar
						incidencias para ayudar a toda la comunidad.</p>
					<div class="u-form u-form-1">
						<form action="FormCreaCustomer">
							<label for="username "
								class="u-align-center u-text u-text-default u-text-grey-75 u-text-2">Usuario</label>
							<div class="u-form-group u-form-name u-form-group-1">
								<label for="name" class="u-form-control-hidden u-label">Nombre</label>
								<input type="text" placeholder="Introduzca su nombre" id="name"
									name="name"
							...
							<div class="u-form-email u-form-group">
								<label for="email"
									class="u-form-control-hidden u-label u-text-palette-4-base">Email</label>
								<input type="email"
									placeholder="Introduce tu correo electrónico" id="email"
									name="email"
									class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
									required="">
							</div>
							<div class="u-form-address u-form-group u-form-group-3">
								<label for="password"
									class="u-form-control-hidden u-label u-text-palette-4-base">Contraseña</label>
							...
							<div class="u-form-agree u-form-group u-form-group-5">
								<input type="checkbox" id="agree-66b6" name="agree"
									class="u-agree-checkbox" required=""> <label
									for="agree-66b6" class="u-agree-label u-label">Acepto
									los <a href="#">términos del servicio</a>
								</label>
							</div>
					...
					<a href="Login.jsp"
						class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-btn-2">¿Ya
						eres miembro? <br>¡Haz click aquí!
					</a>
				</div>
			</div>
		</div>
	...
	<footer class="u-align-left u-clearfix u-footer u-grey-80 u-footer"
		id="sec-24d6">
		<div class="u-clearfix u-sheet u-valign-middle-xs u-sheet-1">
			<span class="u-icon u-icon-circle u-text-black u-icon-1"> </span>
