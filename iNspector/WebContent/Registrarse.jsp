...
<link rel="stylesheet" href="Registrarse.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-4-base u-sticky u-header" id="sec-2a1f"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-shading u-section-1" src="" id="sec-cb27">
        ...
        <div class="u-container-style u-group u-opacity u-opacity-70 u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            ...
            <div class="u-form u-form-1">
              ...
              <label for="username " class="u-align-center u-text u-text-default u-text-grey-75 u-text-2">Usuario</label>
                ...
                <div class="u-form-agree u-form-group u-form-group-5">
                  <input type="checkbox" id="agree-66b6" name="agree" class="u-agree-checkbox" required="">
                  <label for="agree-66b6" class="u-agree-label u-label">Acepto los 
                    <a href="#">términos del servicio</a>
                  </label>
                </div>
                <div class="u-align-center u-form-group u-form-submit">
                  <a href="Principal.jsp" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-button-style">Registrarme</a>
                  <input type="submit" value="submit" class="u-form-control-hidden">
                </div>
