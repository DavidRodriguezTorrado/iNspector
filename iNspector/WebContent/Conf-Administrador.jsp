...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Conf&nbsp; Administrador</title>
          ...
          <div class="u-layout-col">
            ...
            <div class="u-align-center-md u-container-style u-layout-cell u-left-cell u-right-cell u-size-30 u-layout-cell-2">
              <div class="u-container-layout u-container-layout-2">
                <img class="u-expand-resize u-image u-image-1" src="images/57e5d0404254b108f5d08460c62b3f791d37d6ec4e507441702a7dd69f4ac4_1280.png" data-image-width="1280" data-image-height="1252">
                <h2 class="u-align-center-lg u-align-center-sm u-align-center-xl u-align-center-xs u-text u-text-palette-4-base u-text-1">Bienvenido de nuevo Administrador</h2>
                <p class="u-align-center-lg u-align-center-sm u-align-center-xl u-align-center-xs u-text u-text-2">Aquí podrás encontrar una lista de los inspectores pendientes por autorizar.
                  <br>Además podrás añadir un local nuevo a los ya existentes.
                  <br>Si deseas borrar un local que ya existe, encuentrálo en el buscador que aparece arriba y haz click en el botón "borrar". ¡Así de fácil!
                </p>
              </div>
            </div>
          </div>
