    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="sec-c5f0" data-image-width="1280" data-image-height="853">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="FormCreaLocal">
            <input type="hidden" id="siteId" name="siteId" value="57419877">
            <input type="hidden" id="pageId" name="pageId" value="467406325">
            <div class="u-form-group u-form-name">
                <p class="u-align-center u-large-text u-text u-text-font u-text-variant u-text-2">Nombre del local </p>
                  <label for="rotulo" class="u-label u-form-control-hidden">Nombre del local</label>
                  <input type="text" placeholder="Nombre del local" id="rotulo" name="rotulo" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div>
                        <div class="u-form-group u-form-name">
                <p class="u-align-center u-large-text u-text u-text-font u-text-variant u-text-2">Direccion </p>
                  <label for="direccion" class="u-label u-form-control-hidden">Direccion</label>
                  <input type="text" placeholder="Direccion" id="direccion" name="direccion" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div>
                            <div class="u-form-group u-form-name">
                <p class="u-align-center u-large-text u-text u-text-font u-text-variant u-text-2">Epígrafe de actividad </p>
                  <label for="rotulo" class="u-label u-form-control-hidden">Epígrafe de actividad</label>
                  <input type="text" placeholder="Epígrafe de actividad" id="epigrafe" name="epigrafe" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div>
 
            <div class="u-align-right u-form-group u-form-submit">
              <a href="#" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-button-style u-palette-4-base u-btn-1">Crear</a>
              <input type="submit" value="submit" class="u-form-control-hidden">
            </div>
