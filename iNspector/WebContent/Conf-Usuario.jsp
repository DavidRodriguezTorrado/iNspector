  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-4-base u-sticky u-header" id="sec-2a1f"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-be1a">
      <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
        ...
        String favorito1= request.getSession().getAttribute("Favorito1").toString();
        String nameFav1 = request.getSession().getAttribute("FavoritoLocal1").toString();
        String favorito2= request.getSession().getAttribute("Favorito2").toString();
        String nameFav2 = request.getSession().getAttribute("FavoritoLocal2").toString();
        String favorito3=  request.getSession().getAttribute("Favorito3").toString();
        String nameFav3 = request.getSession().getAttribute("FavoritoLocal3").toString();
        String ultimo1= request.getSession().getAttribute("Ultimo1").toString();
        String nameUlt1 = request.getSession().getAttribute("UltimoLocal1").toString();
        String ultimo2= request.getSession().getAttribute("Ultimo2").toString();
        String nameUlt2 = request.getSession().getAttribute("UltimoLocal2").toString();
        String ultimo3=  request.getSession().getAttribute("Ultimo3").toString();
        String nameUlt3 = request.getSession().getAttribute("UltimoLocal3").toString();
        %>
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-2" src="" id="carousel_8722">
      <div class="u-clearfix u-sheet u-sheet-1">
                     <% if (favorito1.equals("0")){
     %><p class="u-text u-text-3">Aquí aparecerán tus locales favoritos</p>
     ...
     %>
              <div class="u-container-style u-layout-cell u-left-cell u-size-20 u-size-20-md u-layout-cell-1">
                <div class="u-border-4 u-border-palette-4-base u-container-layout u-container-layout-1">
                  ...
                  <h3 class="u-align-center u-custom-font u-font-oswald u-text u-text-palette-4-base u-text-1"><%=nameFav1 %></h3>
     ...
     %>
              <div class="u-container-style u-layout-cell u-size-20 u-size-20-md u-layout-cell-2">
                <div class="u-border-4 u-border-palette-4-base u-container-layout u-container-layout-2">
                  ...
                  <h3 class="u-align-center u-custom-font u-font-oswald u-text u-text-palette-4-base u-text-3"><%=nameFav2 %></h3>
     ...
     %>
              <div class="u-container-style u-layout-cell u-right-cell u-size-20 u-size-20-md u-layout-cell-3">
                <div class="u-border-4 u-border-palette-4-base u-container-layout u-container-layout-3">
                  ...
                  <h3 class="u-align-center u-custom-font u-font-oswald u-text u-text-palette-4-base u-text-5"><%=nameFav3 %></h3>
		...
		l10.91-15.757h7.281l9.048,19H3.168L12.216,39.584z"></path>
              ...
              <%} %>
      			...
      			<form action="FormVerTodosFavoritos">
    <div class="u-align-center u-form-group u-form-submit">
                  <button type="submit" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-button-style">Ver todos</button>
    ...
    <section class="u-align-left u-clearfix u-section-3" id="sec-a376">
     ...
     %><p class="u-text u-text-3">Aquí aparecerán las incidencias que reportes</p>
     ...
     %>
              <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-47 u-layout-cell-2">
                ...
                <div class="u-align-center u-container-style u-layout-cell u-right-cell ">
                  <form action="VerIncidencia" class="u-align-center">
                  <input class="u-form-control-hidden" id="incidencia" name="incidencia" value=<%=incidencia1 %>>
                  <input class="u-form-control-hidden" id="local" name="local" value=<%=nameInc1 %>>
                  <button type="submit" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-align-center u-palette-4-base u-btn-1 u-button-style">Ver Incidencia</button>
                  </form>
                  </div>
            </div>
          </div>
   ...
   <section class="u-align-left u-clearfix u-section-3" id="sec-a376">
          ...
          <div class="u-layout">
            <div class="u-layout-row">
              ...
              <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-47 u-layout-cell-2">
                ...
                <div class="u-align-center u-container-style u-layout-cell u-right-cell ">
                  <form action="VerIncidencia" class="u-align-center">
                   <input class="u-form-control-hidden" id="incidencia" name="incidencia" value=<%=incidencia2 %>>
                   <input class="u-form-control-hidden" id="local" name="local" value=<%=nameInc2 %>>
                  <button type="submit" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-align-center u-palette-4-base u-btn-1 u-button-style">Ver Incidencia</button>
                  </form>
                  </div>
            </div>
          ...
          <div class="u-layout">
            <div class="u-layout-row">
              ...
              <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-47 u-layout-cell-2">
                ...
                <div class="u-align-center u-container-style u-layout-cell u-right-cell ">
                  <form action="VerIncidencia" class="u-align-center">
                  <input class="u-form-control-hidden" id="incidencia" name="incidencia" value=<%=incidencia3 %>>
                   <input class="u-form-control-hidden" id="local" name="local" value=<%=nameInc3 %>>
                  <button type="submit" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-align-center u-palette-4-base u-btn-1 u-button-style">Ver Incidencia</button>
                  </form>
                  </div>
            </div>
    ...
    <section class="u-border-2 u-border-white u-clearfix u-image u-shading u-section-6" id="sec-6208" data-image-width="1600" data-image-height="1067">
        ...
        <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-row">
              <div class="u-size-60">
                                    <% if (ultimo1.equals("0")){
     %><p class="u-text u-text-3">Aquí aparecerán los ultimos locales que visites</p>
     ...
     %>
                  <div class="u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-1" data-href="#">
                    <div class="u-container-layout u-valign-bottom u-container-layout-1">
                      ...
                      <h1 class="u-heading-font u-text u-title u-text-2" data-animation-name="lightSpeedIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction=""><%=nameUlt1 %></h1>
                 	<div class="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
     ...
     %>
		<div class="u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-1" data-href="#">
                    <div class="u-container-layout u-valign-bottom u-container-layout-1">
                      <h1 class="u-heading-font u-text u-title u-text-2" data-animation-name="lightSpeedIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction=""><%=nameUlt2 %></h1>
     ...
     %>
                  <div class="u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-1" data-href="#">
                    <div class="u-container-layout u-valign-bottom u-container-layout-1">
                      <h1 class="u-heading-font u-text u-title u-text-2" data-animation-name="lightSpeedIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction=""><%=nameUlt3 %></h1>
                 	<div class="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
