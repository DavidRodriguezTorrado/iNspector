  ...
  <body class="u-body u-overlap"><header class="u-clearfix u-header u-palette-4-base u-sticky u-header" id="sec-2a1f"><div class="u-clearfix u-sheet u-sheet-1">
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
		 ...
		 <% HttpSession s= request.getSession();          
           ...
           s.setAttribute("Nombre", "");
           s.setAttribute("NombreInspector", "");
           s.setAttribute("Usuario", "");
           s.setAttribute("Mail", "");
           s.setAttribute("MailInspector", "");
           s.setAttribute("Password", "");
           s.setAttribute("PasswordInspector", "");
           s.setAttribute("NRPInspector", "");
	 ...
	 <p class="u-align-center u-text u-text-default u-text-grey-75 u-text-2"> Has salido correctamente</p>
             
                       
                <div class="u-align-center u-form-group u-form-submit">
                  <a href="Principal.jsp" class="u-border-radius-10 u-btn u-btn-round u-btn-submit u-button-style">Volver</a>
